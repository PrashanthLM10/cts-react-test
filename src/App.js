    ...
    <section className='app-ctr'>
      ...
      <section className='message-ctr'>
        ...
        <section className='message-btn-ctr'>
          <Button variant='outlined' className='refresh-btn footer-btn' onClick={getLatestMessage}>
            <CachedRoundedIcon />
            <span>Refresh</span>
          </Button>
          <Button variant='outlined' className='clear-btn footer-btn' onClick={clear}>
            <ClearRoundedIcon />
            <span>Clear</span>
          </Button>
          <Button variant='contained' className='save-btn footer-btn' onClick={save}>
            <DoneRoundedIcon />
            <span>Save</span>
          </Button>
        </section>
